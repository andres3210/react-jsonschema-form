...
Code coverage reports are currently available only for the `@northek/rjsf-core` package. They are generated using [nyc](https://github.com/istanbuljs/nyc) each time the `npm test-coverage` script is run.
