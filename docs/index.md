...
```bash
$ npm install @northek/rjsf-core --save
```
...
```html
  <script src="https://unpkg.com/@northek/rjsf-core/dist/react-jsonschema-form.js"></script>
```

Source maps are available at [this url](https://unpkg.com/@northek/rjsf-core/dist/react-jsonschema-form.js.map).
